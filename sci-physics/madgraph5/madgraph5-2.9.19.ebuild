...
# No clue why 2.x version is stored under 3.x
SRC_URI="https://launchpad.net/mg5amcnlo/3.0/3.5.x/+download/${MY_PN}${PV}.tar.gz -> ${MY_PNN}-${PV}.tar.gz"
S="${WORKDIR}/${MY_PF}"
...
src_install() {
	# symlink entrypoint
	dosym ../../opt/${MY_PF}/bin/mg5_aMC /usr/bin/mg5_aMC$(ver_cut 1)
	dosym  ../opt/${MY_PF} /opt/"${MY_PNN}-$(ver_cut 1)"
