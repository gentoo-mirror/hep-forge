...
SLOT="7"
KEYWORDS="~amd64"
IUSE="tauola photos" # pythia vbfnlo openloops njet gosam madgraph
REQUIRED_USE="
	${PYTHON_REQUIRED_USE}
"
...
RDEPEND="
	...
	>=sci-physics/thepeg-2.1.0[lhapdf,fastjet,hepmc2,rivet]
	<sci-physics/evtgen-02.00.00[pythia,herwig,tauola?,photos?]
	<=sci-physics/pythia-8.3:8=
	${PYTHON_DEPS}
"
DEPEND="${RDEPEND}"
BDEPEND="
