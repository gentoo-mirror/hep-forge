...
SLOT="3"
KEYWORDS="~amd64"
IUSE="+lhapdf +fastjet +pythia +ninja +samurai +collier +pineappl +thepeg +herwig autoupdate"
...
src_configure() {
	use lhadpf && echo "lhapdf_py3 = lhapdf-config" >> input/mg5_configuration.txt
